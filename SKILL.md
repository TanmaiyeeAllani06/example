...
`assets/onboarding-templates.md`, prevents duplicate PRs, and opens a pull request
...
- `SKILL.md`
- `assets/onboarding-templates.md`
- `assets/validate-copilot-agent.yml`
...
- `assets/onboarding-templates.md` and `assets/validate-copilot-agent.yml` present in this skill folder
...
Read `assets/onboarding-templates.md` from this skill folder. For each `## TARGET:`
section, create the file at the specified target path using the section content
verbatim.

| Section in `assets/onboarding-templates.md` | Target path |
|---|---|
...
Copy `assets/validate-copilot-agent.yml` from this skill folder to:

```
/tmp/$REPO_NAME-onboarding/.github/workflows/validate-copilot-agent.yml
```

If `assets/validate-copilot-agent.yml` is missing from the skill folder, stop and
...
| `assets/onboarding-templates.md` missing | Stop and report skill package is incomplete. |
